...
export default class EmployeeEditor extends Component{
    ...
    save(){
        this.props.originalEmployee.updateName(this.state.employee.name);
        this.props.originalEmployee.updatePhone(this.state.employee.phone);
        this.props.originalEmployee.updateTitle(this.state.employee.title);
